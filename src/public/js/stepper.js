...
var _bsStepper = _interopRequireDefault(require("bs-stepper"));
...
document.addEventListener('DOMContentLoaded', function () {
  var stepper = new _bsStepper.default(document.querySelector('.bs-stepper'));
  var bsNextSteppers = document.querySelectorAll('.bs-stepper-next');
  var bsPreviousSteppers = document.querySelectorAll('.bs-stepper-previous'); // Next step event listeners

  bsNextSteppers.forEach(function (nextStep) {
    return nextStep.addEventListener('click', function () {
      return stepper.next();
    });
  }); // Previous step event listeners

  bsPreviousSteppers.forEach(function (previousStep) {
    return previousStep.addEventListener('click', function () {
